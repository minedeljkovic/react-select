...
var Wrapper = React__default.createClass({
  displayName: 'Wrapper',

  propTypes: {
    children: React__default.PropTypes.oneOfType([React__default.PropTypes.arrayOf(React__default.PropTypes.node), React__default.PropTypes.node])
  },
...
Select$1.propTypes = {
	...
	openAfterFocus: React__default.PropTypes.bool, // boolean to enable opening dropdown when focused
	wrapperComponent: React__default.PropTypes.func, // component to wrap select in
	wrapperProps: React__default.PropTypes.object // custom properties for Wrapper component
};
